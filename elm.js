...
Elm.Root.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var root = "https://raw.githubusercontent.com/Chadtech-Online-1/Chadtech-Online-1.github.io/master/";
...
Elm.Ship.make = function (_elm) {
   "use strict";
   _elm.Ship = _elm.Ship || {};
   if (_elm.Ship.values) return _elm.Ship.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.Ship.values = {_op: _op,Ship: Ship};
};
